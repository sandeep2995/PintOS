...
bool
dir_create (disk_sector_t sector, disk_sector_t parent_sector, size_t entry_cnt, char *dir_name) 
{
	/**************Added for 4**************************/
	...
	struct dir *parent_dir = dir_open(inode_open(parent_sector));
	dir_add(parent_dir, dir_name, sector, true);
	dir_close(new_dir);
